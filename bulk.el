...
;(auto-fill-mode t) ; need to add to hook to use this in a specific buffer
(setq default-fill-column 88) ; toggle wrapping text at the 88th character
...
;;  :hook python-mode
;;  :general
;;  (leader-def "w" '(my/wrapping :which-key "fill mode"))
;;  :ensure t
;;  :init
;;  (fci-mode)
;;  )
